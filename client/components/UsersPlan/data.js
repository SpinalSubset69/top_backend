...
export const Plan1 = {
    h1: "Top Group(TG)",
    subtitle: "Únete a nuestras clases grupales en un amplio horario.",
    planIco: tgIco,
    descrip1: "Rutina semipersonalizada.",
...
export const Plan3 = {
    h1: "Personal Training (PT)",
    subtitle: "Atención 100% personalizada",
    planIco: ptIco,
    descrip1: "Elaboración de rutina exclusiva.",
...
export const Plan4 = {
    h1: "Entrenamiento en casa",
    subtitle: "Diseñado para usuarios que deseen tener un entrenador en casa",
    descrip1: "Rutinas personalizadas",
...
export const Plan5 = {
    h1: "Entrenamiento Mixto",
    subtitle: "Este plan consta de una combinación de presencial y asistencia en casa.",
    descrip1: "Rutinas específicas",
    descrip2: "Contarás con un entrenador personal en todo momento.",
